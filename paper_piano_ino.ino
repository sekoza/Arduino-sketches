...
void loop()                    
{
  ...
  long total4 =  cs_2_6.capacitiveSensor(1000);
  long total5 =  cs_2_7.capacitiveSensor(1000);
  long total6 =  cs_2_8.capacitiveSensor(1000);
  long total7 =  cs_2_9.capacitiveSensor(1000);
  long total8 =  cs_2_10.capacitiveSensor(1000);
